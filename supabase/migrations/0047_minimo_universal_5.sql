-- =============================================================================
-- LA PANCA — Mínimo universal: S/5 en cualquier categoría
-- 0047_minimo_universal_5.sql
--
-- 0045 había puesto el mínimo en 5 SOLO para blackjack y lo dejó en 10 para
-- el resto. Ahora se pide S/5 para todas las categorías por igual, así que
-- deja de tener sentido distinguir por `categoria` — el mínimo es una sola
-- constante.
--
-- Mismo cuerpo de 0045 con `v_minimo` fijo en 5 en vez de calculado por
-- categoría.
-- =============================================================================
...
declare
  ...
  v_es_fake boolean;
  v_minimo constant numeric(12, 2) := 5;
begin
