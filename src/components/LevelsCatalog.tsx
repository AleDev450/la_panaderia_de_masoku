...
export function LevelsCatalog() {
  return (
    <Panel className="p-4">
      <h2 className="font-fantasy text-sm font-semibold uppercase tracking-wide text-gold-light">
        Niveles
      </h2>
        ...
        {LEVELS.map((level) => (
          <li key={level.id} className="flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              <p className="truncate text-xs font-semibold text-parchment/90">{level.nombre}</p>
